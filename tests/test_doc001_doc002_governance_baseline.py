...
def test_governance_foundation_documents_required_checks() -> None:
    text = read("docs/governance/governance_foundation.md")
...
def test_documentation_drift_baseline_marks_wave_search_as_unvalidated() -> None:
    text = read("docs/governance/documentation_drift_baseline.md")
...
def test_search_intelligence_current_state_contains_operational_snapshot() -> None:
    text = read("docs/architecture/search_intelligence_current_state.md")
...
def test_readme_and_roadmap_link_governance_and_eo002b() -> None:
    ...
    assert "docs/governance/governance_foundation.md" in readme
    assert "docs/governance/documentation_drift_baseline.md" in readme
...
def test_eo002b_plan_defines_guest_list_metrics_and_non_goals() -> None:
    text = read("docs/planning/eo002b_candidate_reprocessing_url_finder_validation.md")
