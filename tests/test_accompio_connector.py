...
from src.connectors.accompio import (
    COMPANY_NAME,
    SOURCE_NAME,
    SOURCE_TYPE,
    AccompioConnector,
...
DETAIL_URL = 'https://karriere.accompio.com/jobs/product-owner-data-platform'
...
def test_connector_fetches_bounded_relevant_jobs() -> None:
    connector = AccompioConnector(listing_url=LISTING_URL, fetcher=fake_fetcher)
