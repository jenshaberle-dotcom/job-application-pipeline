...
def test_build_implementation_writes_candidate_files_without_activation() -> None:
    ...
    assert str(implementation.docs_path) == "docs/source_analysis/hdi_connector_candidate_implementation.md"
    ...
    assert "Generated by the S2V" in implementation.docs_content
...
def test_gate_stop_lines_are_user_readable_without_traceback_language() -> None:
    ...
    assert "STOP:" in text
    assert "No connector candidate files were written." in text
