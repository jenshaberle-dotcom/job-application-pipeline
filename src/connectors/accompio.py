...
SOURCE_FAMILY = 'accompio'
SOURCE_TARGET = None
SOURCE_TYPE = 'employer_origin_career_site'
COMPANY_NAME = 'accompio GmbH'
LISTING_URL = 'https://karriere.accompio.com/de'
ALLOWED_HOSTS = ('karriere.accompio.com',)
KNOWN_DETAIL_URLS = ('https://karriere.accompio.com/de?id=51980f', 'https://karriere.accompio.com/de?id=458ccb', 'https://karriere.accompio.com/de?id=54663b', 'https://karriere.accompio.com/de?id=84543f', 'https://karriere.accompio.com/de?id=57f643')
REQUEST_TIMEOUT_SECONDS = 20
MAX_DETAIL_PAGES = 3
USER_AGENT = (
    "job-application-pipeline-accompio-connector-candidate/0.1 "
...
class AccompioConnector(JobSourceConnector):
