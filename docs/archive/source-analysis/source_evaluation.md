...
This principle is documented for S2C in `docs/archive/source-analysis/aggregator_discovery_feasibility_matrix.md`.

## Terminology Alignment

Source evaluations use the shared project terminology from `docs/reference/glossary.md`, ADR-022, ADR-026, ADR-027 and ADR-028.
...
Limited result-card connector implemented. See `docs/archive/source-analysis/stepstone.md`.
...
Before expanding additional source targets, the project records a current source-coverage baseline in `docs/archive/source-analysis/source_coverage_baseline.md`.
...
See `docs/archive/source-analysis/source_target_selection_matrix.md`.
...
See also `docs/archive/source-analysis/historical_burden.md`.
