...
S2B has been documented in `docs/archive/source-analysis/aggregator_discovery_assessment.md`.
...
S2E has been documented in `docs/archive/source-analysis/employer_candidate_false_negative_review.md`.
...
S2F has been documented in `docs/archive/source-analysis/employer_origin_source_candidate_review.md`.
...
S2G has been documented in `docs/archive/source-analysis/active_source_target_decision_after_s2f.md`.
...
S2H has been documented in `docs/archive/source-analysis/finanz_informatik_origin_path_review.md`.
...
S2I has been documented in `docs/archive/source-analysis/finanz_informatik_bounded_source_target_spike_design.md`.
...
S2L has been documented in `docs/archive/source-analysis/finanz_informatik_incremental_uniqueness_review.md`.
...
S2M connector candidate has been documented in `docs/archive/source-analysis/finanz_informatik_connector_candidate.md`.
...
S2N has been documented in `docs/archive/source-analysis/finanz_informatik_activation_gate.md`.
...
S2O has been documented in `docs/archive/source-analysis/export_as_input_refactoring_audit.md`.
...
S2O-A1 has been documented in `docs/archive/source-analysis/finanz_informatik_legacy_spikes_retirement.md`.
...
S2O-B has been documented in `docs/archive/source-analysis/historical_burden_db_backed_review_state.md`.
...
S2Q defines the employer-origin connector build process in `docs/archive/source-analysis/employer_origin_connector_build_process.md`.
