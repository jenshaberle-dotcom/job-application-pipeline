...
This source analysis uses the shared project terminology from `docs/reference/glossary.md`, ADR-022, ADR-023, ADR-026 and ADR-027.
...
- `docs/archive/planning/relevance_and_search_quality.md`
...
See `docs/archive/source-analysis/aggregator_discovery_feedback_loop.md`.
