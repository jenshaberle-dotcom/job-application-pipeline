...
See `docs/archive/source-analysis/source_strategy_review.md`.
...
See `docs/archive/source-analysis/aggregator_discovery_assessment.md`.
...
See `docs/archive/source-analysis/aggregator_discovery_feasibility_matrix.md`.
