# Registration Execution Plan — finanz_informatik
...
- Register `finanz_informatik:hannover` in ingestion CLI/runner connector mapping.
- Import `src.connectors.finanz_informatik` and its connector class.
...
- `pytest -q`
- `python -m scripts.run_employer_origin_connector_validation_agent --company-key finanz_informatik`
