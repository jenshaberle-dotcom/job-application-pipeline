...
1. local Markdown links such as `../reference/product/README.md`, and
...
`docs/archive/source-analysis/aggregator_discovery_assessment.md`:
...
- the employer-origin review reference was corrected to the existing
  `docs/archive/source-analysis/employer_origin_source_candidate_review.md` file.
...
Before moving larger `docs/archive/planning/` or `docs/archive/source-analysis/` batches:
