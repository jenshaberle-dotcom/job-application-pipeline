...
- Added `docs/reference/database/README.md` as the database documentation entry point.
- Added `docs/reference/database/schema_overview.md` with domain-level table/view grouping.
- Added `docs/reference/database/schema_relationships.md` with Mermaid relationship maps.
- Marked `docs/reference/database/tables.md` as useful but incomplete for the current
...
`docs/current/system-diagrams.md` and database relationship diagrams now
exist in `docs/reference/database/schema_relationships.md`.

After that, a generated link/reference check should precede any large
`docs/archive/planning/` or `docs/archive/source-analysis/` moves.
