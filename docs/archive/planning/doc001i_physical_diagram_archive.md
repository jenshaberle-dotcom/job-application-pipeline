...
|---|---|---|
| `docs/diagrams/architecture.md` | `docs/archive/diagrams/architecture.md` | `docs/current/system-diagrams.md` |
| `docs/diagrams/bronze_data_model.md` | `docs/archive/diagrams/bronze_data_model.md` | `docs/reference/database/schema_relationships.md` |
...
DOC-001I does not mass-move `docs/archive/planning/` or `docs/archive/source-analysis/`.
