...
|---|---|---|---|---|
| ADR-001 | Accepted | Current | Keep as foundational source-realism decision. | `docs/current/architecture.md` |
| ADR-002 | Accepted | Current | Keep; interpret through raw-first/tolerant Bronze and later evidence gates. | `docs/current/architecture.md`, `docs/reference/database/schema_overview.md` |
...
| ADR-010 | Accepted | Current | Keep with caveat that true canonical-source resolution remains deferred. | `docs/reference/database/schema_overview.md` |
| ADR-011 | Accepted | Current | Keep; technical duplicates and cross-source matching remain separate. | `docs/reference/database/schema_overview.md` |
| ADR-012 | Accepted | Current | Keep; observation/source-value concepts remain active. | `docs/reference/database/schema_overview.md`, `docs/reference/observability/source_health_and_heartbeat.md` |
| ADR-013 | Accepted | Current | Keep as product-intent ancestor; prefer Current System Overview for wording. | `docs/current/architecture.md` |
...
| ADR-021 | Accepted | Current | Keep; source capability expansion remains current. | `docs/reference/sources/source_capabilities.md` |
| ADR-022 | Accepted | Current | Keep; shared terminology remains useful. | `docs/reference/search-intelligence/terminology.md` |
| ADR-023 | Accepted | Current | Keep; search-result connector contract remains active. | `docs/reference/sources/search_result_connector_contract.md` |
| ADR-024 | Accepted | Current | Keep; relevance/search-quality boundary remains active. | `docs/reference/scoring-and-gates/relevance_strategy.md` |
| ADR-025 | Accepted | Current | Keep; search-term lineage remains required for quality evaluation. | `docs/reference/scoring-and-gates/relevance_strategy.md` |
