...
Documentation updates that touch diagrams, dashboard descriptions, README visuals, presentation assets or frontend plans must check the project visual identity defined in [`docs/design/`](../product/README.md).
...
- [ADR-031: Define platform visual identity and documentation design rules](../../decisions/adr/031_define_platform_visual_identity.md)
