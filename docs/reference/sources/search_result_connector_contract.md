...
- `docs/decisions/adr/009_use_connector_based_ingestion.md`
- `docs/decisions/adr/010_define_canonical_job_model_for_silver_layer.md`
- `docs/decisions/../decisions/adr/022_define_shared_source_and_layer_terminology.md`
