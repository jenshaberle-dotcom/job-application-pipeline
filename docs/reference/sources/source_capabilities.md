...
This document uses the shared terminology from `docs/reference/glossary.md`, ADR-022, ADR-023, ADR-026, ADR-027 and ADR-028.
...
- `docs/reference/sources/search_result_connector_contract.md`
- `docs/decisions/../decisions/adr/023_define_search_result_connector_contract.md`
- `docs/decisions/../decisions/adr/026_define_source_acquisition_scope_and_canonical_source_strategy.md`
- `docs/decisions/../decisions/adr/027_define_source_target_acquisition_model.md`
- `docs/decisions/../decisions/adr/028_separate_source_family_target_and_type.md`
