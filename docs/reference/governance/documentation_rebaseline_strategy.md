...
`docs/archive/planning/` should be treated as historical build logs by default.
...
`docs/archive/source-analysis/` should be treated as historical or reference material by
