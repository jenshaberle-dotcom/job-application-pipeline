...
- [ADR-022](../decisions/adr/022_define_shared_source_and_layer_terminology.md)
- [ADR-023](../decisions/adr/023_define_search_result_connector_contract.md)
- [ADR-026](../decisions/adr/026_define_source_acquisition_scope_and_canonical_source_strategy.md)
- [ADR-027](../decisions/adr/027_define_source_target_acquisition_model.md)
- [ADR-028](../decisions/adr/028_separate_source_family_target_and_type.md)
- [Search Result Connector Contract](sources/search_result_connector_contract.md)
...
- [Design and Platform Identity](product/README.md)
- [ADR-031](../decisions/adr/031_define_platform_visual_identity.md)
...
- docs/reference/search-intelligence/terminology.md
