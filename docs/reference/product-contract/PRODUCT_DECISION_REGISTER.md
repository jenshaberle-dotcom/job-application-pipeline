...
| ID | Status | Decision required |
|---|---|---|
| `PD-010` | recorded_repo_truth_pending_confirmation | Confirm the hierarchy: Machine Learning Engineer foundation, Data Engineering/data-centric ML focus, AI Reliability future direction, GenAI cross-cutting competency. |
| `PD-011` | open_operator_decision | Approve target role families and exact title/alias families. |
...
| ID | Status | Decision required |
|---|---|---|
| `PD-020` | recorded_repo_truth_pending_confirmation | Confirm Hannover and remote-in-Germany as the primary market boundary. |
| `PD-021` | open_operator_decision | Define commute radius or maximum travel time from Hannover. |
| `PD-022` | open_operator_decision | Define acceptable office-frequency and hybrid rules. |
| `PD-023` | open_operator_decision | Define what qualifies as remote in Germany. |
...
| `PD-043` | recorded_repo_truth_pending_confirmation | Confirm whether an official/origin source is required for Top-5 confirmation. |
| `PD-044` | open_operator_decision | Define treatment of aggregator-only jobs with strong detail evidence. |
...
| `PD-052` | open_operator_decision | Approve ranking factors and their relative importance. |
...
| ID | Status | Decision required |
|---|---|---|
| `PD-080` | open_operator_decision | Define the minimum end-to-end V1 journey. |
| `PD-081` | open_operator_decision | Define V1 UI/device expectations. |
