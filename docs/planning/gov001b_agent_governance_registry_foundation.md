...
- `docs/governance/agent_governance_registry.md`
- `docs/governance/agent_capability_audit.md`
- `docs/governance/agent_responsibility_model.md`
...
- `docs/project_state/` remains untracked handover/runtime context unless explicitly handled separately
