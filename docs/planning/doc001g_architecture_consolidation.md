...
- Rebuilt `docs/architecture/system_diagrams.md` around the current end-to-end
  Search Intelligence control surface.
- Added learning and repair-loop diagrams.
- Added `docs/architecture/architecture_document_status.md` as the control
  surface for architecture document authority.
- Updated `docs/architecture/README.md`, `docs/README.md`, and
  `docs/architecture/current_truth_documentation_map.md` to include the new
  status surface.
